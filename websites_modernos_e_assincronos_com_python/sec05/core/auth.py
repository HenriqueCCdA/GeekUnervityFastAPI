...
def try_hex_to_int(valor_hex: str) -> int:
    """Tenta concerter um calor hexadecimal  para inteiro ou devolve 0"""
...
def gerar_hash_senha(senha: str) -> str:
    """Função que gero e retorna o hash de um texto/senha"""
...
def verificar_senha(senha: str, hash_senha: str) -> bool:
    """Função que verificar se a senha é igual ao hash contido no banco de dados"""
...
def get_membro_id(request: Request) -> Optional[int]:
    ...
    # Separa asa partes através do ponto
    partes = valor.split(".")
